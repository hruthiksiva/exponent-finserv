  ...
  return (
    ...
    <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div className="col-lg-6">
        ...
        <h1 className="display-3 fw-bold lh-2 mb-3">Expert Loaning Agent For Your Bussiness Success</h1>
        <p className="fw-normal mb-4">One platform for all your problems</p>
