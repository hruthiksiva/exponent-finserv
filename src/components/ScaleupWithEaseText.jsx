...
const ScaleupWithEaseText = () => {
  return (
      ...
      <div className="container-fluid py-5">
        ...
        <div className="row">
        <div className="col-6">
          <img src="src/assets/images/legacy-3.jpg" className="d-block mx-lg-auto img-fluid rounded-4 shadow" alt="Bootstrap Themes" width="600" loading="lazy" />

          </div>
          <div className="col-md-6">
          <h1 className="display-5 fw-bold">Scale-Up with Ease: Seamless, Fast Bussiness Loan Solutions!</h1>
